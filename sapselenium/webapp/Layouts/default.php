...
<script language="JavaScript" type="text/javascript" src="xpath/xmlextras.js"></script>
...
<body onLoad="start();">
    ...
    <form action="" name="controlPanel">
      ...
      <tr class="selenium">
        <td width="25%" height="30%" ><iframe name="testSuiteFrame" id="testSuiteFrame" src="<?= SAUrl::Url('tests', array($this->app->getGPEventsName() => 'suite')) ?>" application="yes"></iframe></td>
